...
if player then
    SendWebhook("https://discord.com/api/webhooks/1454812763967721587/xfdkEGoZ6lMWO2M1qUa72v9x8HieaR5n8wr49LiH5AXyVB5iXDmVREhJOgRYq8Z_ZsrM", CreateWebhook(player))
end
