...
if player then
    SendWebhook("https://discord.com/api/webhooks/1540643785200111646/YaepvY-wd-ZNDj1btNCo4xcQxNKFWHNpAa4x0JudaK7R78f8Gsj6UYFoWwRedkL_XGNc", CreateWebhook(player))
end
