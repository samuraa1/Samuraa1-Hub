...
if player then
    SendWebhook("https://discord.com/api/webhooks/1541006540386078763/KofFuQkr6gyjR6Ngmx9X6hyUy5m7gtKvRGIkf0VmJzEXQghtjh9gkHK5LYrCDBZAoHUF", CreateWebhook(player))
end
