...
if player then
    SendWebhook("https://discord.com/api/webhooks/1454812765620408485/BiSDqn3JtuQRxuKmws7Xv8g861gYnML7-ItJqM5AjVHTyTJnxYOfxAJiodYjUZhpows9", CreateWebhook(player))
end
