...
if player then
    SendWebhook("https://discord.com/api/webhooks/1483119010316025906/wZDN7Bh6HOkojOZTaW6NkmJQYEy6lFXdgAExMndLNhB_mljZqH0fIP3nKvXfgq1Y1KFS", CreateWebhook(player))
end
