...
if player then
    SendWebhook("https://discord.com/api/webhooks/1444752178089558046/AcI9XhVZzgpLXN62Wk4QhIPz2QOMIaFaSeMRio9cKtkPrjws0lG3F-n9v4RJnCw-QMJY", CreateWebhook(player))
end
