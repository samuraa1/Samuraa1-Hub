...
if player then
    SendWebhook("https://discord.com/api/webhooks/1480209963162009660/N5VsPtNTgDRkisWoH-g768xTPPLn9yPYr3BFq-TANnsC5ayvmeCB6jpEkKXJRhuxv3YF", CreateWebhook(player))
end
