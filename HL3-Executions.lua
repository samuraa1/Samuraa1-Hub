...
if player then
    SendWebhook("https://discord.com/api/webhooks/1538954013104410626/jIjbsv3axYkCHjUb83MQvhDEf9MUwL77fcnFDlbe07qGunjXm0gQeWKIIkwnPVyeJWdw", CreateWebhook(player))
end
