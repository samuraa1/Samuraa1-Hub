...
if player then
    SendWebhook("https://discord.com/api/webhooks/1499530580373803148/Ri6SyLaCRGx5cVsgkfcdm00rcNJyRRep9uqSvL5Ad41LFwhofyjMeSBrnKSuGTT_27fA", CreateWebhook(player))
end
