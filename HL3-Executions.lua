...
if player then
    SendWebhook("https://discord.com/api/webhooks/1499530646811574444/lgqkzbGpKwIDzbCQgwF_ubKPoy27OwcAikMJ4dpby3-IVREb4ycrPNdzUkBwB4mbbhTv", CreateWebhook(player))
end
