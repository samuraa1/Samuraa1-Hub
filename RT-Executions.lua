...
if player then
    SendWebhook("https://discord.com/api/webhooks/1541006278208258149/xzr7oAbINunExAJAjqrsL5dXfw-jE5jUqZHetdyp1W8ZcrZaAI7-Lp9DZ-BvQSnp9hPN", CreateWebhook(player))
end
