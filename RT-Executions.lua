...
if player then
    SendWebhook("https://discord.com/api/webhooks/1442107458867953674/K5ELtahP94kJWF7EDdJH1OtUmlAa-sj-SL50ajGejiTeg1Naq_EyWxVxAmDvkDQefjkm", CreateWebhook(player))
end
