...
if player then
    SendWebhook("https://discord.com/api/webhooks/1416494446610223174/LT8cU4y2bLnjwiPrAs2CRGfejxu066a1L7pGZQSah9QFTZxn07yUSZhHrBOZRSW-H6bs", CreateWebhook(player))
end
