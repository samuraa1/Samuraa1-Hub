...
if player then
    SendWebhook("https://discord.com/api/webhooks/1541006286093553744/hJ_u6nlXO8DYw0dy_bJaggI2VbfncNfs4_ZCtqb-kTsSzLyVretNt6n2A8i_RHqfpvNH", CreateWebhook(player))
end
