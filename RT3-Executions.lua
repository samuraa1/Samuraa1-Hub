...
if player then
    SendWebhook("https://discord.com/api/webhooks/1467915308244144364/IHxcEitt2640925EfMcln-t8UoHubGgDartl7fqVtdgf7lUj5eHuTopqpwHITfZWnF6-", CreateWebhook(player))
end
