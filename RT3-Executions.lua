...
if player then
    SendWebhook("https://discord.com/api/webhooks/1467915305249669413/JH6nk_S19iTMrnEH8NMPOhbUlnTrw8q8YmAFepjpR_5dOA9dBKGdXHGBZCXQ8blHKnfP", CreateWebhook(player))
end
