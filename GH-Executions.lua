...
if player then
    SendWebhook("https://discord.com/api/webhooks/1478378801116479631/m7tk123Wtd-xVaFOz1rhlAWl_dUAmqP2ZtZvW7cltCe-SS-dqyqdyLoSmH8nkzOV7_Py", CreateWebhook(player))
end
