...
if player then
    SendWebhook("https://discord.com/api/webhooks/1479855201522548807/sEY1oxTJVisB6IIIl29hRe52LPfEvosdV3QKeAn_RacyQUjcFRfNrHOCHODJ6WnbSUVu", CreateWebhook(player))
end
