...
if player then
    SendWebhook("https://discord.com/api/webhooks/1475186268697661472/WRCgbGx8iOsM_8MPj1400I_tZoXEvI9getDzjRMupHJh_ziJgHKuLrpO6Ft3jg5wyONS", CreateWebhook(player))
end
