...
if player then
    SendWebhook("https://discord.com/api/webhooks/1500184297347219657/WFZrqunYEf5KDUyb2HSkXzGcCIDKapV8Hf0AjKlf8HkYdKuARi_17avtwuNWKxed-d8-", CreateWebhook(player))
end
