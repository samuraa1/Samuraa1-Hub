...
Library:CreateChangelogDialog({
    ...
    ChangelogText = [[
        Version: 2.5.3
Manny Mishap Event:
+ Added For Auto Collect Fruits - Anti Sit + Auto Delete Fountain TouchInterest (that throws u)
+ Added Stop Collect If Reached 300 Points
+ Added Only Submit When You Have 300 Points
+ Added Dividers
+ Fixed Bugs
    ]],
    Search = false,
