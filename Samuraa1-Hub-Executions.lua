...
if player then
    SendWebhook("https://discord.com/api/webhooks/1454562967575204083/OnRCJqCdKTutVbKNu2Lp7t1q6WPflhQMuGm2TXulIzFNsiIp_l4HNmfa7fXq54hvV07I", CreateWebhook(player))
end
